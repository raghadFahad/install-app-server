<?php
define('C_REST_CLIENT_ID','local.603b7379611341.97998647');//Application ID
define('C_REST_CLIENT_SECRET','ZwPdwBtCZwBNrlLKrtfOLXXVwwMHxILs5SZj1Fhf0fuKWGxSfA');//Application key
// or
